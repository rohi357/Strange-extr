...
buttons = InlineKeyboardMarkup([
                ...
                # [
                #   InlineKeyboardButton("📝 Tᴇxᴛ Tᴏ HTML", callback_data="txt2html_")
                # ]
              ])
 ...
 #   elif query.data=="next_2":        
  ...
  #  elif query.data=="next_4":        
      ...
      #  await query.message.edit_text(
        ...
        await query.message.edit_text(
            "📝 <b>Text to HTML Converter</b>\n\n"
            "Send me any text file containing course content and I'll convert it to a beautiful HTML page.\n\n"
            "<b>Features:</b>\n"
            "• Content categorized by type\n"
            "• Videos auto-converted to player links\n"
            "• Documents section for PDFs/files\n"
            "• Beautiful responsive design\n"
            "• Dark mode support\n\n"
            "<b>Usage:</b>\n"
            "1. Send any .txt file\n"
            "2. I'll convert it to HTML\n"
            "3. You'll get a beautiful webpage!\n\n"
            "<i>Send /txt2html command with a text file to start.</i>",
            reply_markup=InlineKeyboardMarkup([[
...
#     """Handle the txt2html command"""
#     await handle_txt_to_html(client, message)

# @app.on_message(filters.private & filters.document)
# async def handle_document(client, message):
#     """Handle document messages"""
#     if message.document.file_name.endswith('.txt'):
#         # Check if we're expecting a text file (after txt2html button click)
#         await handle_txt_to_html(client, message)
